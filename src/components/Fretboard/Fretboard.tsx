...
const SCALE_DEGREE_COLORS: Record<number, string> = {
  1: '#9a0000', // Root - blood crimson
  2: '#6b3200', // 2nd - deep ember
  3: '#736500', // 3rd - ancient gold
  4: '#0d4220', // 4th - shadow forest
  5: '#102065', // 5th - prussian night
  6: '#30087a', // 6th - violet depths
  7: '#5a0090', // 7th - elder violet
}

// Colors for triad degrees (Root, 3rd, 5th)
const TRIAD_DEGREE_COLORS: Record<number, string> = {
  1: '#9a0000', // Root - blood crimson
  2: '#736500', // 3rd - ancient gold
  3: '#102065', // 5th - prussian night
}
...
const EXTENDED_CHORD_DEGREE_COLORS: Record<number, string> = {
  ...
  3: '#102065', // 5th - prussian night
  4: '#5a0090', // 7th - elder violet
  5: '#6b3200', // 9th - deep ember
  6: '#0d4220', // 11th - shadow forest
  7: '#30087a', // 13th - violet depths
}
