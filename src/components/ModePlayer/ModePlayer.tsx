...
import { MODE_TRACK_ROOTS, MODE_TYPES, MODE_LABELS, getNoteDisplay } from '../../utils/music'
...
export function ModePlayer({ modeType, selectedString, onModeTypeChange, onSingleStringModeChange, onSelectedStringChange, onPracticeModeChange }: ModePlayerProps) {
  ...
  return (
    <div className={styles.player}>
      ...
      <div className={styles.transport}>
        ...
        <span className={styles.key}>Key: {getNoteDisplay(MODE_TRACK_ROOTS[modeType])}</span>
      </div>

      {practiceMode === 'off' ? (
        <div className={styles.practiceButtons}>
          <button className={styles.practiceButton} onClick={startSinglePractice}>
            Single Mode
          </button>
          <button className={styles.practiceButton} onClick={startRandomPractice}>
            Random
          </button>
        </div>
      ) : (
        <div className={styles.practiceActive}>
          ...
          <button className={styles.stopButton} onClick={stopPractice}>Stop</button>
        </div>
      )}
    </div>
  )
